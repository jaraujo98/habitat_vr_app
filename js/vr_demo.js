...
class VRDemo {
  ...
  static preloadFiles(preloadFunc) {
    ...
    preloadFunc(dataUrlBase + "/stages/remake_v0_JustBigStuff_00.stage_config.json");
  ...
  initSimAndSensors() {
    ...
    this.config.scene_id = "data/webxr_hand_demo_dataset/stages/remake_v0_JustBigStuff_00.glb";
  ...
  initScene() {
    ...
    Module.loadAllObjectConfigsFromPath(this.sim, "/data/webxr_hand_demo_dataset/objects");
